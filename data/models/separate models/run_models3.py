...
#f = open("modeling results/separate_model_fits-kids.txt", "w+")

f = open("modeling results/separate_model_fits-bland.txt", "w+")

f.write('subj RL_llh B_value Lag_llh B_lag \n')
...
for subj_data in beh_data[:]:
        ...
        outputs = [subj, RL_nllh, B_value, Lag_nllh, B_lag]
