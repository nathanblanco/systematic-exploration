...
f = open("modeling results/RL_params_children.txt", "w+")

f.write('subj RL_aic RL_alpha RL_Bev\n')
...
for subj_data in beh_data[:]:
        ...
        [RL_nllh, RL_alpha, RL_Bev] = RL.do_fit(subj_data, 4, 6, 4)
        
        outputs =  [get_aic(RL_nllh, 2), RL_alpha, RL_Bev]
